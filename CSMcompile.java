...
public class CSMcompile {
  ...
  public static void buildCSM( jsV def ){
    ...
    if (csts==null) 
      ...
      for (int i=0; i< CsmState.nCSMstates; i++ ){
        ...
        System.out.println( nPred + " => " + st.nm + " => " + nSucc );
      }
    }
  }
  ...
  public static void main(String[] args)  throws Exception {
    System.out.println( "CSMcompile of 2021-Apr-18" );
    ...
    cF.println( "// generated by CSMcompile.java at " + LocalDateTime.now().format(DATE_FORMATTER) );
    ...
    System.out.println( "  " + jsh.FirstLine );
    jsV def = jsh.result;
