...
//  "initial version comment";
  ...
  public static void main(String[] args)  throws Exception {
    System.out.println( "org.amplio.CSMcompile version: " + version );
    ...
    cF.println( "// generated by org.amplio.CSMcompile version: " + version );
    ...
    dF.println( "org.amplio.CSMcompile " + version + " from " + file.toAbsolutePath() + " of " + formatDateTime( attr.lastModifiedTime())  );
    ...
    wrDataStates( dF );
    dF.close();
    System.out.println( "org.amplio.CSMcompile wrote " + out_data_path );
    ...
    if ( ErrorCount > 0 ){
      System.out.println( "org.amplio.CSMcompile reported " + ErrorCount + " problems, output may be incorrect." );
    //  System.exit( ErrorCount );
    }
    System.out.println( "org.amplio.CSMcompile wrote " + out_path );
  }
}
